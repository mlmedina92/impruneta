...
<!--        <link rel="stylesheet" type="text/css" media="screen" href="css/demo.min.css">-->
    ...
    <div class="modal-content" id="payment_promise">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel" style="color: #0d0d0d; font-weight: bold">VALIDACIÓN</h4>
        </div>
        <div class="modal-body">
            <form id="form_verifica_consulta" method="post">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label" style="color: #0d0d0d; font-weight: bold;">Enviar codigo de confirmacion por: </label>
                                <div class="row">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn_enviar_codigo_conf" onclick="send_code_confirm();" class="btn btn-primary" style="background-color: #0d0d0d">
                        Enviar
                    </button>
 ...
 <h4 class="modal-title" id="myModalLabel" style="color: #0d0d0d; font-weight: bold">NUESTRAS AGENCIAS DE PAGO</h4>

                            </div>
                            <div class="modal-body" style="height: 520px">
                                <div id="map-container-google-3" class="z-depth-1-half map-container-3">
                                  <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d26272.07768742445!2d-58.42835855658266!3d-34.60391594938584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sFactora!5e0!3m2!1ses!2spe!4v1570517529047!5m2!1ses!2spe" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="jarviswidget" id="wid-id-1" style="border-top: none; border-left: none">
                                <div style="border-top: 1px solid #CCC; border-left: 1px solid #CCC; border-width: 1px 1px 1px 1px;">
                                    <div class="widget-body">
                                        <fieldset>
                                            <legend style="padding-top: 0px"><h1 style="color:#0d0d0d; font-weight: bold">CONSULTA TU DEUDA</h1></legend>
                                        </fieldset>
                                        <form id="form_consulta_deuda" class="form-horizontal">
                                            {{csrf_field()}}
                                            <fieldset>
                                                <div class="form-group">
                                                    <label class="control-label col-md-1" style="padding-top: 10px;color: #0d0d0d; font-weight: bold;" for="appendprepend">DNI:</label>
                                                    <div class="col-md-2">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                ...
                                                <label style="color:#0d0d0d" for="dni" class="fa fa-list-alt" rel="tooltip" title="" data-original-title="Ingrese el numero del Dni"></label>
                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <label class="control-label col-md-1" style="padding-top: 10px; text-align: left;color: #0d0d0d; font-weight: bold;" for="appendprepend">TELEFONO:</label>
                                                    <div class="col-md-2">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="icon-addon addon-md">
                                                <input type="text" id="txtTelefono" name="txtTelefono" placeholder="Teléfono" class="form-control" value="" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                                <label  style="color:#0d0d0d" for="telefono" class="fa fa-phone" rel="tooltip" title="" data-original-title="Ingrese un numero telefonico"></label>
                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <label class="control-label col-md-1" style="padding-top: 10px;color: #0d0d0d; font-weight: bold;" for="appendprepend">EMAIL:</label>
                                                    <div class="col-md-5">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="icon-addon addon-md">
                                                <input type="text" id="txtEmail" name="txtEmail" placeholder="Email" class="form-control" value="">
                                                <label  style="color:#0d0d0d" for="email" class="fa fa-envelope" rel="tooltip" title="" data-original-title="Ingrese una direccion Email"></label>
                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <fieldset>
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label col-md-1" style="padding-top: 10px;color: #0d0d0d; font-weight: bold; visibility: hidden;" for="appendbutton">Captcha</label>
                                                            ...
                                                            <div class="col-sm-12" align="right">
                                                                <div class="input-group" align="right">
                                                                    ...
                                                                    <div class="input-group-btn" style="text-align: left;display: none">
                                                                        <div class="captcha">
                                                                            <span id="id_captcha" style="border-color:#0d0d0d">{!! captcha_img() !!}</span>
                                                                            <button type="button" id="refresh_captcha" class="btn btn-success btn-refresh" style="background-color: #0d0d0d; border-color: #0d0d0d"><i class="fa fa-refresh"></i></button>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <form id="checkout-form" class="form-horizontal" novalidate="novalidate">
                                            <fieldset>
                                                <div class="jarviswidget" role="no-menu"  id="wid-id-0" data-widget-editbutton="false">
                                                    <header style="background-color: #0d0d0d; border-color: #0d0d0d; color: #ffffff">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        <div class="col-md-4" style="padding-left: 0px">
                                                            <a href="https://api.whatsapp.com/send?phone=5491150035249&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20mi%20deuda." target="_blank">
                                                            <img src="{!! asset('images/whatsapp.png') !!}" style="width: 50px">
                                                            <label style="font-weight: bold; font-size: 20px; color: #0d0d0d; cursor:pointer;">+54 9 11 5003 - 5249</label>
                                                            </a>
                                                        </div>
                                                        <!--<div class="col-md-4" style="padding-left: 0px">
