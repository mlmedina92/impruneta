<form id="form_verifica_consulta" method="post">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label" style="color: #0d0d0d; font-weight: bold;">Ingresar el codigo de confirmacion: </label>
                    <div class="row">
    ...
    <div class="modal-footer">
        <button type="button" id="btn_enviar_codigo_conf" onclick="verifica_codigo_confirmacion();" class="btn btn-primary" style="background-color: #0d0d0d">
            Enviar
        </button>
