...
<body>
  ...
  border-spacing: 20px;" width="70%">
		<tr>
			<td colspan="2" style="background-color: #0d0d0d; color: #FFFFFF;padding-left: 5px; padding-top: 2px; padding-bottom: 2px"><strong>Datos del Titular</strong></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" style="background-color: #0d0d0d; color: #FFFFFF;padding-left: 5px; padding-top: 2px; padding-bottom: 2px"><strong>Datos de la Deuda</strong></td>
		</tr>
		<tr>
		...
		<tr>-->
			<td colspan="2" style="background-color: #0d0d0d; color: #FFFFFF;padding-left: 5px; padding-top: 2px; padding-bottom: 2px"><strong>Datos del Compromiso de pago</strong></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" style="background-color: #0d0d0d; color: #FFFFFF;padding-left: 5px; padding-top: 2px; padding-bottom: 2px"><strong>Opciones de Pago</strong></td>
		</tr>
		<tr>
			<td style="padding-left: 5px; padding-top: 2px; padding-bottom: 2px">Código RAPIPAGO:</td>
	...
	<table>
		...
		<tr>
			<td><img src="http://www.imprunetasa.com/images/logo.png" alt="SmartAdmin" style="width: 350px"></td>
		</tr>
	</table>
