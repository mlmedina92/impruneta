  ...
  <div class="form-container">
    ...
    <form action="#" id="formCallMe">
      <div class="form-group">
        ...
        <input type="text" id="nombre" name="nombre" class="form-control form-input "  />
      </div>
      <div class="form-group">
        <label for="">DNI</label>
        <input class="form-control form-input " name="dni" id="dni" minlength="8" type="number " />
      </div>
      <div class="form-group">
        <label for="">Celular</label>
        <input class="form-control form-input " name="celular" id="celular" type="phone" />
      </div>
