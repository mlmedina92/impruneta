...
<div class="modal-dialog" style="width:800px">
	<div class="modal-content" id="payment_promise">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel" style="color: #0d0d0d; font-weight: bold">COMPROMISO DE PAGO</h4>
		</div>
		<div class="modal-body" style="padding-top: 12px; padding-bottom: 5px">
			<form id="form_compromiso_deuda" method="post">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group" style="margin-bottom: 5px">
							<label for="category" style="color: #0d0d0d; font-weight: bold;"> Titular</label>
					...
					<div class="col-md-4">
						<div class="form-group"  style="margin-bottom: 5px">
							<label for="category" style="color: #0d0d0d; font-weight: bold;"> Email</label>
					...
					<div class="col-md-4">
						<div class="form-group"  style="margin-bottom: 5px">
							<label for="tags" style="color: #0d0d0d; font-weight: bold;"> Teléfono</label>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group"  style="margin-bottom: 5px">
							<label for="tags" style="color: #0d0d0d; font-weight: bold;"> DNI</label>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="category" style="color: #0d0d0d; font-weight: bold;"> Entidad</label>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="tags" style="color: #0d0d0d; font-weight: bold;"> Producto</label>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="tags" style="color: #0d0d0d; font-weight: bold;"> Importe de Deuda</label>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="tags" style="color: #0d0d0d; font-weight: bold;"> Fecha de Mora</label>
				...
				@if($opciones_cuotas != "")
				<input type="hidden" id="txtOpcionPagoVal" name="txtOpcionPagoVal" value="2">
				<div class="row">
					<div class="col-md-8">
						<div class="form-group">
							<div class="row">
				...
				@else
				<input type="hidden" id="txtOpcionPagoVal" name="txtOpcionPagoVal" value="1">
				@endif
				...
				<!--<div class="row">
					<div class="col-md-3" id="id_imp_anticipo_elemento" style="display:none">
						<label style="color: #0d0d0d; font-weight: bold;">Anticipo</label>
					...
					<div class="col-md-3" id="id_fec_anticipo_elemento" style="display:none">
						<label style="color: #0d0d0d; font-weight: bold;">Fecha Anticipo</label>
				...
				<div class="row" id="id_tipo_pago_cancelatoria" style="display:">
					...
					<div class="col-md-5">
						<div class="form-group">
							<label style="color: #0d0d0d; font-weight: bold;">Seleccionar fecha de cancelación</label>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="category" style="color: #0d0d0d; font-weight: bold;"> N° de cuotas</label>
					...
					<div class="col-md-3">
						<div class="form-group">
							<label for="tags" style="color: #0d0d0d; font-weight: bold;" > Importe cancelatorio</label>
							<input type="text" class="form-control" placeholder="Tags" value="<?php echo "$ ".number_format($importe_cuota,2); ?>" name="txtImporteCuota_una" id="txtImporteCuota_una" readonly="readonly" />
						</div>
					</div>

					<!--<div class="col-md-3" id="id_fec_anticipo_elemento_normal" style="display:none">
						<div class="form-group">
							<label for="tags" style="color: #0d0d0d; font-weight: bold; margin-bottom: 5px > Fecha 1ra Cuota</label>
				...
				<div class="row">
					<div class="col-md-5">
						<div class="form-group"  style="margin-bottom: 5px">
							<label style="color: #0d0d0d; font-weight: bold;">Seleccionar fecha de anticipo</label>
							<div class="input-group">
					...
					<div class="col-md-4" id="id_imp_anticipo_elemento">
						<label style="color: #0d0d0d; font-weight: bold;">Importe del anticipo</label>
						<input type="text" class="form-control" placeholder="{!! number_format($deuda->anticipo_deuda,2) !!}" value="$ {!! number_format($deuda->anticipo_deuda,2) !!}" name="txtImporteAnticipo" id="txtImporteAnticipo" readonly="readonly" />
					</div>
				...
				<div class="row">
					<div class="col-md-5" id="id_fec_anticipo_elemento_normal">
						<div class="form-group">
							<label for="tags" style="color: #0d0d0d; font-weight: bold; margin-bottom: 5px" > Fecha de pago de la 1ra Cuota</label>
							<input type="text" class="form-control" placeholder="DD/MM/YYYY" value="" name="txtFechaAnticipo" id="txtFechaAnticipo" readonly="readonly" />
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="category" style="color: #0d0d0d; font-weight: bold; margin-bottom: 5px"> N° de cuotas</label>
							<div id="cb_cuotas">
								<select class="form-control" id="cbTipoPago" name="cbTipoPago" readonly="readonly" onchange="change_fee();">
									<option value="1" selected="selected">01 Cuota</option>
								</select>
					...
					<div class="col-md-3">
						<div class="form-group">
							<label for="tags" style="color: #0d0d0d; font-weight: bold; margin-bottom: 5px" > Importe de cada cuota</label>
				...
				<div class="row">				
					<div class="col-md-12">
						<div class="row">				
							<div class="col-md-3">
								<label for="tags" style="color: #0d0d0d; font-weight: bold; margin-top: 7px"> Código RAPIPAGO:</label>
								<input type="hidden" name="txtOptTipoPagoRapipago" value="{!!$inst_rapipago_inst_pago!!}">
							</div>
							<div class="col-md-6">
								<input name="txtCodigoRapiPago" id="txtCodigoRapiPago" type="text" class="form-control" placeholder="Tags" value="{!!$codigo_rapipago!!}" readonly="readonly" style="margin-bottom: 8px; background-color: #BDBDBD; color: #000000">
							</div>
				...
				<div class="row">				
					<div class="col-md-12">
						<div class="row">				
							<div class="col-md-3">
								<label for="tags" style="color: #0d0d0d; font-weight: bold; margin-top: 7px"> Código PAGOFACIL:</label>
							</div>
							<div class="col-md-6">
								<!--<a href="javascript:void(0);" class="btn btn-default" style=""> <strong>{!!$codigo_pagofacil!!}</strong></a>-->
								<input name="txtCodigoPagoFacil" id="txtCodigoPagoFacil" type="text" class="form-control" placeholder="Tags" value="{!!$codigo_pagofacil!!}" readonly="readonly" style="margin-bottom: 8px; background-color: #BDBDBD; color: #000000">
							</div>
							<div class="col-md-3" style="margin-top: 7px">
								...
								<input type="hidden" name="txtOptTipoPagoPagofacil" value="{!!$inst_pagofacil_inst_pago!!}">
							</div>
						</div>
					</div>
				</div>	
				...
				<div class="row" style="padding-bottom: 10px">				
					<div class="col-md-12">
						<div class="row">				
							<div class="col-md-3">
								<label for="tags" style="color: #0d0d0d; font-weight: bold; margin-top: 7px"> Otras formas de pago:</label>
							</div>
							<div class="col-md-6">

							</div>
							<div class="col-md-3" style="margin-top: 7px">
								<a href="javascript:void(0);" rel="popover" data-placement="top" data-original-title="¿Cómo pagar?" data-html="true" data-content="{!!$inst_transferencia_pago!!}">¿Cómo pagar? Click aquí</a>
								<input type="hidden" name="txtOptTipoPagoOtros" value="{!!$inst_transferencia_pago!!}">
							</div>
						</div>
					</div>
				</div>								
				...
				<div id="id_resumen_comp_cancelatoria">
					<div class="alert alert-success fade in">
						...
						Registramos una <strong>Cancelacion</strong> de <strong> $ <?php echo number_format($importe_cuota,2); ?> </strong> para el <strong id="id_fecha_cancelatoria"> dd/mm/yyyy </strong>
					</div>
				</div>
				...
				<div id="id_resumen_comp_anticipo" style="display: none">
					<div class="alert alert-success fade in">
						...
						Registramos un <strong>Anticipo</strong> de <strong> $ <?php echo number_format($deuda->anticipo_deuda,2) ?> </strong> pesos para el <strong id="id_fecha_anticipo"> dd/mm/yyyy </strong> y un pago de <strong id="id_nro_cuotas_st"> 2 </strong> cuotas de <strong id="id_importe_anticipo_st"> $ <?php echo number_format($importe_cuota,2); ?></strong> cada una.
					</div>
				</div>
				...
				<!--<div class="row">
					...
					<div class="col-md-4" style="padding-right: 0px">
						<div class="form-group">
							<label for="tags" style="color: #0d0d0d; font-weight: bold;"> Codigo RapiPago</label>
					...
					<div class="col-md-8" style="padding-right: 0px">
						<div class="form-group">
							<label for="tags" style="color: #0d0d0d; font-weight: bold;"> Codigo PagoFacil</label>
							<a href="javascript:void(0);" class="btn btn-default" style=""> <strong>{!!$codigo_pagofacil!!}</strong></a>
				...
				<!--<div class="row">
					<div class="col-sm-6">
						<label style="color: #0d0d0d; font-weight: bold;">Fecha de compromiso de pago</label>
					</div>
				...
				<div class="modal-footer">
					...
					<button type="button" id="btn_guardar_compromiso" onclick="save_payment_promise();" class="btn btn-primary" style="background-color: #0d0d0d">
