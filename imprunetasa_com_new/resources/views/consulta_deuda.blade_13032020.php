...
<html lang="en-us">
    ...
    <div class="modal-content" id="payment_promise">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <form id="form_consulta_deuda" class="form-horizontal">
                                            ...
                                            <fieldset>
                                                ...
                                                <input id="txtDni" name="txtDni" type="text" placeholder="Dni" class="form-control" value="36953761" data-toggle="tooltip" data-placement="top" title="Tooltip on top" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                                <label style="color:#29a22d" for="dni" class="fa fa-list-alt" rel="tooltip" title="" data-original-title="Ingrese el numero del Dni"></label>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="icon-addon addon-md">
                                                <input type="text" id="txtTelefono" name="txtTelefono" placeholder="Telefono" class="form-control" value="994668875" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                                <label  style="color:#29a22d" for="telefono" class="fa fa-phone" rel="tooltip" title="" data-original-title="Ingrese un numero telefonico"></label>
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="icon-addon addon-md">
                                                <input type="text" id="txtEmail" name="txtEmail" placeholder="Email" class="form-control" value="jperez@gmail.com">
                                                            ...
                                                            <div class="col-sm-12" align="right">
                                                                <div class="input-group" align="right">
                                                                    ...
                                                                    <div class="input-group-btn" style="text-align: right;">
                                                                        <button type="button" data-toggle="modal" data-target="#myModalEjemplo" class="btn btn-warning" style="margin-left: 10px">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        <div class="col-md-4" style="padding-left: 0px">
                                                            <a href="https://api.whatsapp.com/send?phone=51955081075&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20mi%20deuda." target="_blank">
        ...
        function send_code_confirm(){
            alert("No se encontro la plantilla para el envio de la notificacion...");
            //$('#form_verifica_consulta').html("<h1>Carlos</h1>");
        }
        ...
        function save_payment_promise(){
            ...
            var fecha_compromiso = $.trim($('#dtpicker').val());
